...
/*   Updated: 2023/03/24 11:10:34 by jsauvain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << "You cannot attack " << _name << ", he is already dead";
		std::cout << std::endl;
	}
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (_hitPoints > 0)
	{
		if (_energyPoints > 0)
		{
			_hitPoints += amount;
			_energyPoints--;
			std::cout << "ClapTrap " << _name << " regain " << amount << " hit points";
			std::cout << std::endl;
		}
		else
		...
		std::cout << _name << " cannot heal, he is already dead !" << std::endl;
}
